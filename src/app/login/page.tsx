      ...
      <main className="flex-grow relative flex items-center justify-center p-container-padding">
        ...
        <div className="relative z-10 w-full max-w-[420px] flex flex-col gap-max-gap">
          ...
          <div className="bg-surface-container border border-outline-variant rounded p-stack-base flex flex-col gap-max-gap shadow-2xl backdrop-blur-sm">
            ...
            <form className="flex flex-col gap-max-gap" onSubmit={(e) => e.preventDefault()}>
              {/* Operator ID */}
              <div className="flex flex-col gap-1">
                <label className="font-label-caps text-label-caps text-on-surface-variant px-unit">OPERATOR IDENTIFIER</label>
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="relative flex items-center glow-border rounded">
                  ...
                  <input
                    ...
                    type="password"
                  />
                  <button className="absolute right-3 hover:text-primary transition-colors" type="button">
              ...
              {/* Action Button */}
              <button className="w-full bg-primary hover:bg-white text-on-primary font-headline-md text-headline-md py-2 rounded transition-all duration-200 active:scale-[0.98] flex items-center justify-center gap-stack-base group">
            ...
            <div className="flex justify-between items-center px-unit border-t border-outline-variant pt-stack-base mt-unit">
              <a className="font-label-caps text-label-caps text-on-surface-variant hover:text-primary transition-colors uppercase cursor-pointer" href="#">Request Reset</a>
              <div className="w-px h-3 bg-outline-variant"></div>
              <a className="font-label-caps text-label-caps text-status-danger hover:brightness-125 transition-colors uppercase cursor-pointer flex items-center gap-1" href="#">
                <span className="material-symbols-outlined !text-[12px]">emergency_home</span>
                Emergency Access
              </a>
            </div>
          </div>
