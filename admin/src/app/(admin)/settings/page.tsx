  ...
  return (
    <>
      ...
      <div className="w-full flex flex-col gap-3.5">
        {/* Header */}
        <div className="bg-surface-bright rounded-xl border border-subtle p-3.5 md:p-4 shadow-sm flex flex-col md:flex-row md:justify-between md:items-center gap-3">
          <div>
            <div className="flex items-center gap-2.5">
              <span className="material-symbols-outlined text-2xl text-primary">settings_applications</span>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3 py-1.5 rounded-lg border border-subtle bg-surface-container hover:bg-surface-container-high text-on-surface font-label-caps text-xs font-bold flex items-center gap-1 transition-colors"
            ...
            <button
              ...
              disabled={saving}
              className="bg-primary text-on-primary px-3.5 py-1.5 rounded-lg font-label-caps text-xs font-bold flex items-center gap-1.5 hover:opacity-90 transition-opacity disabled:opacity-50 shadow-sm"
            >
        ...
        {/* Quick Info Bar */}
        {maintenanceMode && (
          <div className="bg-status-danger/10 border border-status-danger/30 rounded-xl p-3 flex items-center justify-between text-status-danger animate-fadeIn shadow-sm">
            <div className="flex items-center gap-2.5">
              <span className="material-symbols-outlined text-[24px]">warning</span>
              <div>
                <span className="font-bold text-xs">MAINTENANCE MODE IS CURRENTLY ACTIVE</span>
            ...
            <button
              ...
              className="bg-status-danger text-white px-3 py-1 rounded-lg text-xs font-bold font-label-caps hover:brightness-110 shadow-sm"
            >
              DISABLE NOW
            </button>
          </div>
          ...
          {TAB_CONFIG.map((t) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-1.5 px-3.5 py-1.5 rounded-lg font-label-caps text-xs font-bold transition-all whitespace-nowrap ${
                  isActive
              ...
              >
                ...
                <span>{t.label}</span>
                {t.id === "banners" && (
                  <span className="ml-1 bg-surface-container px-1.5 py-0.5 rounded-full text-[9px] text-on-surface font-bold">
                    {banners.length}
                  </span>
                )}
                {t.id === "faqs" && (
        ...
        {activeTab === "general" && (
          <div className="flex flex-col gap-3.5 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
              ...
              <div className="bg-surface-bright p-3.5 md:p-4 rounded-xl border border-subtle shadow-sm flex flex-col justify-between">
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                      <span className="material-symbols-outlined text-secondary text-[20px]">power_settings_new</span>
                  ...
                  <div className="p-3 bg-surface-container-low rounded-lg border border-outline-variant/50 flex items-center justify-between">
                    <div>
                      <span className="font-bold font-body-md text-xs text-on-surface block">App-wide Lock</span>
                      <span
                        className={`text-[10px] font-bold font-label-caps ${
                ...
                <div className="bg-surface-container p-3.5 md:p-4 rounded-xl border border-outline-variant flex flex-col justify-between">
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                      <span className="material-symbols-outlined text-secondary text-[20px]">monetization_on</span>
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <select
                      className="w-full bg-surface-container-low border border-outline-variant rounded-lg p-2 font-body-md text-xs text-on-surface focus:border-secondary outline-none cursor-pointer"
              ...
              <div className="w-full bg-surface-container p-3.5 md:p-4 rounded-xl border border-outline-variant flex flex-col gap-3">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <span className="material-symbols-outlined text-secondary text-[20px]">system_update</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-0.5">
                  <div className="bg-surface-container-low p-3 rounded-lg border border-outline-variant">
                    <div className="flex items-center gap-2 mb-1.5">
                      <span className="material-symbols-outlined text-status-success text-[18px]">android</span>
                      <span className="font-label-caps font-bold text-xs text-on-surface">ANDROID OS VERSION</span>
                    </div>
                    <input
                      className="w-full bg-surface-container-lowest border border-outline-variant rounded-lg px-2.5 py-1.5 font-data-mono text-xs text-primary focus:border-secondary outline-none"
                      type="text"
                  ...
                  <div className="bg-surface-container-low p-3 rounded-lg border border-outline-variant">
                    <div className="flex items-center gap-2 mb-1.5">
                      <span className="material-symbols-outlined text-status-info text-[18px]">phone_iphone</span>
                      <span className="font-label-caps font-bold text-xs text-on-surface">APPLE IOS VERSION</span>
                    </div>
                    <input
                      className="w-full bg-surface-container-lowest border border-outline-variant rounded-lg px-2.5 py-1.5 font-data-mono text-xs text-primary focus:border-secondary outline-none"
                      type="text"
                    ...
                    />
                    <span className="text-[10px] text-on-surface-variant block mt-0.5">App Store version requirement</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          {activeTab === "modules" && (
            <div className="flex flex-col gap-3.5 animate-fadeIn">
              <div className="bg-surface-container p-3.5 rounded-xl border border-outline-variant">
                <h2 className="font-headline-md text-headline-md text-on-surface flex items-center gap-2 mb-0.5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
                {moduleList.map((m) => {
                  ...
                  return (
                    <div
                      key={m.key}
                      className={`bg-surface-container p-3.5 md:p-4 rounded-xl border transition-all flex flex-col justify-between ${
                    ...
                    >
                      <div className="flex items-start justify-between gap-2.5 mb-2.5">
                        <div className="flex items-center gap-2.5">
                          <div
                            className={`w-9 h-9 rounded-lg bg-surface-container-low border border-outline-variant flex items-center justify-center ${m.color}`}
                          >
                            <span className="material-symbols-outlined text-[20px]">{m.icon}</span>
                          </div>
                          <div>
                            <h3 className="font-body-md font-bold text-on-surface text-sm">{m.label}</h3>
                            <span
                              className={`inline-block px-2 py-0.2 rounded-full text-[9px] font-label-caps font-bold mt-0.5 ${
                                enabled
                      ...
                      <p className="text-body-sm text-xs text-on-surface-variant border-t border-outline-variant/30 pt-2">
                        {m.description}
                      </p>
                    </div>
                  );
          ...
          {activeTab === "banners" && (
            <div className="flex flex-col gap-3.5 animate-fadeIn">
              <div className="flex justify-between items-center bg-surface-container px-3.5 py-2.5 rounded-xl border border-outline-variant">
                <div>
                ...
                <button
                  ...
                  className="bg-secondary text-on-secondary px-3.5 py-1.5 rounded-lg font-label-caps text-xs font-bold flex items-center gap-1 hover:opacity-90 transition-opacity shadow"
                >
                  <span className="material-symbols-outlined text-[16px]">add</span> ADD NEW BANNER
                </button>
              </div>
              ...
              {loading ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
                  {Array.from({ length: 2 }).map((_, i) => (
                    <div key={i} className="h-36 bg-surface-container rounded-xl animate-pulse" />
                  ))}
                </div>
              ) : banners.length === 0 ? (
                <div className="bg-surface-container border border-outline-variant rounded-xl p-8 text-center text-on-surface-variant flex flex-col items-center">
                  <span className="material-symbols-outlined text-[44px] opacity-30 mb-1.5">add_photo_alternate</span>
                  <p className="font-bold text-body-md text-sm text-on-surface">No banners configured</p>
                  <p className="text-xs text-on-surface-variant/70 mt-0.5 max-w-sm">
                    Add banners to feature promos, updates, and market events on users' mobile feeds.
                  </p>
                  <button
                    onClick={() => openBannerModal()}
                    className="mt-3 border border-secondary text-secondary px-3.5 py-1.5 rounded-lg font-label-caps text-xs font-bold hover:bg-secondary/10"
                  >
                    CREATE FIRST BANNER
                  </button>
                </div>
                  ...
                  {banners.map((b: any) => (
                    ...
                    >
                      <div>
                        ...
                        <div className="w-full h-32 bg-surface-container-highest relative flex items-center justify-center overflow-hidden border-b border-outline-variant">
                          {b.imageUrl ? (
                            ...
                            <div className="flex flex-col items-center text-on-surface-variant/40">
                              ...
                              <span className="text-[9px] font-data-mono">NO IMAGE URL</span>
                            </div>
                          )}
                          <span
                            className={`absolute top-2 right-2 px-2 py-0.5 rounded-full text-[9px] font-bold uppercase shadow-sm ${
                              b.status === "active"
                        ...
                        {/* Banner Details */}
                        <div className="p-3">
                          <h3 className="font-body-md font-bold text-on-surface truncate text-sm">{b.title}</h3>
                          <p className="text-xs text-on-surface-variant font-data-mono truncate mt-0.5 flex items-center gap-1">
                      ...
                      {/* Card Actions */}
                      <div className="px-3 py-2 bg-surface-container-low border-t border-outline-variant flex justify-between items-center">
                        <span className="font-data-mono text-[10px] text-on-surface-variant">ID: #{b.id?.slice(0, 10)}</span>
                        <div className="flex gap-1.5">
                          <button
                            onClick={() => openBannerModal(b)}
                            className="px-2 py-0.5 rounded bg-surface-container border border-outline-variant text-xs text-on-surface hover:text-secondary flex items-center gap-1 font-label-caps"
                          >
                            <span className="material-symbols-outlined text-[12px]">edit</span> EDIT
                          </button>
                          <button
                            onClick={() => deleteBanner(b.id)}
                            className="px-2 py-0.5 rounded bg-surface-container border border-outline-variant text-xs text-status-danger hover:bg-status-danger/10 flex items-center gap-1 font-label-caps"
                          >
          ...
          {activeTab === "onboarding" && (
            <div className="flex flex-col gap-3.5 animate-fadeIn">
              ...
              {onboarding.length === 0 ? (
                <div className="bg-surface-container border border-outline-variant rounded-xl p-8 text-center text-on-surface-variant flex flex-col items-center">
                  <span className="material-symbols-outlined text-[44px] opacity-30 mb-1.5">view_carousel</span>
                  <p className="font-bold text-body-md text-sm text-on-surface">No onboarding steps defined</p>
                  <p className="text-xs text-on-surface-variant/70 mt-0.5 max-w-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
                  {onboarding.map((s: any, idx: number) => (
                    <div
                      key={s.id}
                      className="bg-surface-container border border-outline-variant rounded-xl p-3.5 flex flex-col justify-between group hover:border-secondary transition-colors shadow-sm relative"
                    >
                      <div>
                        <div className="flex justify-between items-center mb-2">
                          <span className="bg-secondary/15 text-secondary px-2 py-0.5 rounded-full font-label-caps text-[10px] font-bold">
                            STEP {idx + 1}
                          </span>
                        ...
                        <h3 className="font-body-md font-bold text-on-surface text-sm mb-1.5">
                      ...
                      <div className="mt-3 pt-2 border-t border-outline-variant/40 flex items-center justify-between text-[10px] text-on-surface-variant font-data-mono">
          ...
          {activeTab === "faqs" && (
            <div className="flex flex-col gap-3.5 animate-fadeIn">
              <div className="bg-surface-container p-3.5 rounded-xl border border-outline-variant flex flex-col gap-2.5">
                <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-2.5">
                  ...
                  <button
                    ...
                    className="bg-secondary text-on-secondary px-3.5 py-1.5 rounded-lg font-label-caps text-xs font-bold flex items-center gap-1 hover:opacity-90 transition-opacity shadow self-start md:self-auto"
                  >
                    <span className="material-symbols-outlined text-[16px]">add</span> NEW FAQ ITEM
                  </button>
                </div>

                {/* Filter & Search Bar */}
                <div className="flex flex-col md:flex-row gap-2.5 pt-1.5 border-t border-outline-variant/40">
                  <div className="relative flex-1">
                    ...
                    <input
                      type="text"
                      className="w-full bg-surface-container-low border border-outline-variant rounded-lg pl-8 pr-2.5 py-1.5 text-xs text-on-surface focus:border-secondary outline-none"
                  ...
                  <div className="flex gap-1.5 shrink-0">
                    {["all", "general", "transactions", "security"].map((cat) => (
                      <button
                        ...
                        className={`px-2.5 py-1 rounded-lg font-label-caps text-xs capitalize transition-all ${
                          faqCategory === cat
              ...
              {filteredFaqs.length === 0 ? (
                <div className="bg-surface-container border border-outline-variant rounded-xl p-8 text-center text-on-surface-variant flex flex-col items-center">
                  <span className="material-symbols-outlined text-[44px] opacity-30 mb-1.5">quiz</span>
                  <p className="font-bold text-body-md text-sm text-on-surface">No FAQ articles found</p>
                  <p className="text-xs text-on-surface-variant/70 mt-0.5 max-w-sm">
                ...
                <div className="flex flex-col gap-2.5">
                  {filteredFaqs.map((f: any) => (
                    <div
                      key={f.id}
                      className="bg-surface-container border border-outline-variant rounded-xl p-3 hover:border-secondary transition-colors shadow-sm"
                    >
                      <div className="flex justify-between items-start gap-3">
                        <div className="flex-1">
                          <div className="flex items-center gap-1.5 mb-0.5">
                            <span className="px-2 py-0.2 rounded text-[9px] font-label-caps font-bold uppercase bg-surface-container-highest text-secondary">
                              {f.category || "general"}
                            </span>
                          ...
                          <h3 className="font-body-md font-bold text-primary text-sm">{f.question || f.q}</h3>
                          <p className="text-xs text-on-surface-variant mt-1 leading-relaxed whitespace-pre-line">
                            {f.answer || f.a}
                          </p>
                        </div>
                        ...
                        <div className="flex gap-1 shrink-0">
                          <button
                            ...
                            className="p-1 text-on-surface-variant hover:text-secondary rounded bg-surface-container-low border border-outline-variant hover:border-secondary"
                            title="Edit FAQ"
                          >
                          ...
                          <button
                            ...
                            className="p-1 text-on-surface-variant hover:text-status-danger rounded bg-surface-container-low border border-outline-variant hover:border-status-danger"
                            title="Delete FAQ"
                          >
          ...
          {activeTab === "diagnostics" && (
            <div className="flex flex-col gap-3.5 animate-fadeIn">
              <div className="bg-surface-container p-3.5 md:p-4 rounded-xl border border-outline-variant flex flex-col gap-3">
                <div className="flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div className="bg-surface-container-lowest p-3 rounded-lg border border-outline-variant flex flex-col gap-1.5 font-data-mono text-xs">
                ...
                <div className="pt-1.5 flex flex-wrap gap-2.5">
                  <button
                    ...
                    className="bg-surface-container-high border border-outline-variant px-3.5 py-1.5 rounded-lg font-label-caps text-xs font-bold hover:bg-status-danger/15 hover:text-status-danger transition-colors flex items-center gap-1.5"
                  >
